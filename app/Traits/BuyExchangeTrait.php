...
Trait BuyExchangeTrait{
    ...
    public static function calculateNetworkWage($pair_amount, $taker_fee_rate, $pair_price = null)
    {
        if ($pair_price) {

            $total_tether = $pair_amount * $pair_price;
            return ($taker_fee_rate / 100) * $total_tether;

        } else
            return ($taker_fee_rate / 100) * $pair_amount;
    }
